  ...
  render() {
    ...
    return (
      <div role="listitem" id={isIncome ? 'successLi' : 'dangerLi'} className={`transaction-item flex items-center gap-3 p-3.5 rounded-xl mb-2 cursor-default group ${isIncome ? 'border-success' : 'border-danger'}`} style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.05)' }}>
        <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0" style={{ background: `${catColor}18` }} aria-hidden="true">
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          >
            <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#f87171" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-trash-2">
