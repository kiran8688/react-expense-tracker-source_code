    ...
    if (this.props.dispAmount <= 0) {
      ...
      return (amountlist =
        ...
        <div id='list' className=' row fs-4 mb-1'>
          <ul className=' col-11 container-auto bg-white '>
          ...
          <svg id='delete-button' xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-trash3 col-1 mt-3 " viewBox="0 0 16 16">
