    ...
    return (
      <div className='mt-4'>
        ...
        <div className=' fs-3'>
            ...
            <li className=' row justify-content-around rounded border-end border-5 border-success mb-3 p-2 list-group-item shadow d-flex bg-light '> <strong className=' text-truncate col-6'>hello</strong> <span className='col-3 text-secondary'>10/12/2022</span> <span className='col-3'>+$50</span> </li>
